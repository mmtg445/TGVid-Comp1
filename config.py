...
class Config(object):
    ...
    # database config
    DB_URL  = os.environ.get("DB_URL", "mongodb+srv://Rahat1:rWkHLsT8CCeaxPIt@rahat1.dy34u.mongodb.net/?retryWrites=true&w=majority&appName=Rahat1")  # ⚠️ Required
    DB_NAME  = os.environ.get("DB_NAME","SnowEncoderBot") 

    # Other Configs 
    ADMIN = int(os.environ.get("ADMIN", "7945551029")) # ⚠️ Required
